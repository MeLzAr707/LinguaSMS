...
/**
 * Represents an MMS Send Request PDU.
 */
public class SendReq extends GenericPdu {
    ...
    /**
     * Creates a new Send Request PDU.
     */
    public SendReq() {
    ...
    public int getMessageType() {
        return PduHeaders.MESSAGE_TYPE_SEND_REQ;
    }
     ...
     */
    public void setTo(EncodedStringValue[] to) {
        mTo = to;
    }
