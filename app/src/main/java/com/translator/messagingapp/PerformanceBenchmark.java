...
public class PerformanceBenchmark {
    ...
    public long benchmarkOriginalConversationLoading() {
        MessageService messageService = new MessageService(context, new TranslationManager(context));
    ...
    public long benchmarkOptimizedMessageLoading(String threadId, int pageSize) {
        OptimizedMessageService messageService = new OptimizedMessageService(context, new TranslationManager(context));
